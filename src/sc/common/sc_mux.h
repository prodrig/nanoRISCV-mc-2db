...
public:
    ...
    static inline const typename BASE_MODULE::data_t all0{::sc_dt::SC_LOGIC_0};
    static inline const typename BASE_MODULE::data_t all1{::sc_dt::SC_LOGIC_1};

    explicit SyscMux(::sc_core::sc_module_name name) : SyscLogicGate<N,W>(name) {
        BASE_MODULE::sensitive << sel;
    }

    // No copy-constructor or assignment operator
    //SyscMux(const SyscMux&) = delete;
    //SyscMux &operator=(const SyscMux& other) = delete;
...
public:
    ...
    SyscMux_pv<N,W,SELW,SEL_INVALID_BEH,SEL_XORZ_CONV>(::sc_core::sc_module_name name) : SyscLogicGate_pv<N,W>(name) {
